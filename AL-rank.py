...
resultname=DATA_FOLDER+'_result.txt'
'''
rootdir=os.path.dirname(os.path.abspath(sys.argv[0]))
...
policyname=DATA_FOLDER+'_policy.h5'
resultname=DATA_FOLDER+'_ALIL_result.txt'
'''
...
for tau in range(0,EPISODES):
    ...
    for t in range(0,BUDGET):
        ...
        rank_un=getuncertaintyRank(x_pool, x_new, model)
        print('Uncertainty rank:'+str(rank_un))
        rank_div=getdiversityRank(x_pool, x_new, x_trn)
        print('Diversity rank:'+str(rank_div))
        uncertaintyrank.append(rank_un)
        diversityrank.append(rank_div)
        ...
        #print(accuracy)
        #accuracylist[tau].append(accuracy)
...
print('Uncertainty rank: ')
print(uncertaintyrank)
uu=open('uncertaintyRank.txt','w')
uu.writelines(str(line)+ "\n" for line in uncertaintyrank)
uu.close()


print('Diversity rank: ')
print(diversityrank)
ww=open('diversityRank.txt','w')
ww.writelines(str(line)+ "\n" for line in diversityrank)
ww.close()
